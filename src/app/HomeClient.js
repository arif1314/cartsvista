    ...
    <main className={styles.main}>
      ...
      <section className={styles.promoGrid}>
        ...
        <div className={styles.promoRight}>
          <Link
            href={promo2.link || "/c/women"}
            className={`${styles.promoImageWrapper} ${styles.promoTop} ${styles.promoSale}`}
            aria-label="Shop the seasonal sale"
          >
            <Image
              src="/promos/promo2-seasonal-sale.webp"
              alt="Cream and oxblood occasionwear in a burgundy atelier"
              fill
              sizes="(max-width: 900px) calc(100vw - 1.6rem), 46vw"
              loading="eager"
            />
            <div className={styles.promoScrim} />
            <div className={`${styles.promoContent} ${styles.promoSaleContent}`}>
              <span className={styles.promoEyebrow}>Seasonal edit · 2026</span>
              <h2>The Summer<br />Sale</h2>
              <p>Up to 50% off selected styles</p>
              <span className={styles.promoCta}>Shop the edit <ArrowRight size={14} /></span>
            </div>
          </Link>

          <div className={styles.promoBottomRow}>
            <Link
              href={promo3.link || "/c/men"}
              className={`${styles.promoImageWrapper} ${styles.promoTailoring}`}
              aria-label="Explore modern tailoring"
            >
              <Image
                src="/promos/promo3-modern-tailoring.webp"
                alt="Charcoal tailored jacket in a warm atelier"
                fill
                sizes="(max-width: 600px) calc(100vw - 1.6rem), (max-width: 900px) 48vw, 23vw"
                loading="lazy"
              />
              <div className={styles.promoScrim} />
              <div className={`${styles.promoContent} ${styles.promoTailoringContent}`}>
                <span className={styles.promoEyebrow}>The atelier</span>
                <h2>Modern<br />Tailoring</h2>
                <p>Precision in every detail</p>
                <span className={styles.promoCta}>Discover <ArrowRight size={13} /></span>
              </div>
            </Link>

            <Link
              href={promo4.link || "/c/accessories"}
              className={`${styles.promoImageWrapper} ${styles.promoAccessories}`}
              aria-label="Explore signature accessories"
            >
              <Image
                src="/promos/promo4-signature-accessories.webp"
                alt="Perfume, silk and watch arranged on dark stone"
                fill
                sizes="(max-width: 600px) calc(100vw - 1.6rem), (max-width: 900px) 48vw, 23vw"
                loading="lazy"
              />
              <div className={styles.promoScrim} />
              <div className={`${styles.promoContent} ${styles.promoAccessoriesContent}`}>
                <span className={styles.promoEyebrow}>The signature edit</span>
                <h2>Finishing<br />Touches</h2>
                <p>Fragrance · Watches · Silk</p>
                <span className={styles.promoCta}>Explore <ArrowRight size={13} /></span>
              </div>
            </Link>
          </div>
        </div>
