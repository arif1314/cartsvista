          ...
          <div className={styles.productInfo}>
            ...
            <div className={styles.sizeSection}>
              ...
              <div className={styles.stockWarning}>
                <span className={`${styles.stockBadge} ${stock === 0 ? styles.outOfStockBadge : stock > 5 ? styles.inStockBadge : ''}`}>
                  {stockLabel}
                </span>
              </div>
            </div>
            
            <button className={styles.addToCartBtn} onClick={handleAddToCart} disabled={stock === 0}>
              <Lock size={16} className={styles.btnIcon} /> {stock === 0 ? 'Out of stock' : 'Add to bag'}
            </button>
